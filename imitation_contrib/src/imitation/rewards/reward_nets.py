...
class ScaledRewardNet(RewardNet):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bias = nn.Parameter(th.tensor(0.0, requires_grad=True))
...
class PredefinedShapedRewardNet(ShapedRewardNet):
    """MLP that takes as input the state, action, next state and done flag.
...
class ShapedScaledRewardNet(ShapedRewardNet):
    """Shaped reward net based on MLPs.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            kwargs: passed straight through to `BasicRewardNet` and `BasicPotentialMLP`.
        """
        base_reward_net = ScaledRewardNet(
            observation_space=observation_space,
            action_space=action_space,
            reward_fn=reward_fn,
            **kwargs,
