...
<box2d>
  <world timestep="0.03" velitr="10" positr="7">
    <body name="goal" type="static" position="${goal_pos},${cart_height/2}">
      ...
      ##   />
      ## </body>
    ## <body name="pole" type="dynamic" position="0,${plate_offset + pole_height/5}">
    ...
    <body name="pole" type="dynamic" position="0,${plate_offset }">
      ...
      ##         group="1"
      ##         shape="polygon"
      ##         vertices="0, 0; ${-pole_width/2}, ${pole_height}; ${pole_width/2}, ${pole_height}"
      ## />
              ## vertices="${pole_width/3}, ${0}; ${-pole_width/3}, ${0}; ${-pole_width/2}, ${pole_height/1.2}; ${pole_width/2}, ${pole_height/1.2}"
      ...
      <fixture
              ...
              group="1"
              shape="polygon"
              vertices="-0.05, 0 ; 0.05, 0; 0.05, ${pole_height/2};  -0.05, ${pole_height/2}"
      />
      <fixture
              density="0.5"
              friction="${pole_friction}"
              group="1"
              shape="polygon"
              vertices="0, ${2*pole_height/3} ;${pole_width/3}, ${pole_height} ;${0.05 +pole_width/3}, ${pole_height} ; 0, ${2*pole_height/3 - 0.05}"
      />
      ...
      <fixture
              ...
              group="1"
              shape="polygon"
              vertices="${-0.05 -pole_width/3}, ${pole_height} ; ${ -pole_width/3}, ${pole_height} ;0, ${2*pole_height/3} ;0, ${2*pole_height/3 - 0.05}"
      />
      <fixture
              density="2.0"
              friction="${pole_friction*10}"
              group="1"
              shape="polygon"
              vertices="${ - 0.05 +  pole_width/2}, 0 ; ${0.05 - pole_width/2}, 0; ${ 0.05 -  pole_width/2}, 0.05 ; ${-0.05 + pole_width/2}, 0.05"
      />
      ## <fixture
      ##         density="0.5"
      ##         friction="${pole_friction}"
      ##         group="1"
      ##         shape="polygon"
      ##         vertices="${ pole_width/2}, 0 ; ${-0.05 + pole_width/2}, 0; ${ -0.05 + pole_width/2}, ${pole_height};  ${pole_width/2}, ${pole_height}"
      ## />
    </body>
