...
<box2d>
  <world timestep="0.03" velitr="20" positr="14">
    ...
    <body name="pole" type="dynamic" position="0,${plate_offset}">
      ...
      <fixture
              ...
              group="1"
              shape="polygon"
              vertices="${-pole_width/2}, ${pole_height/2}; ${pole_width/2}, ${pole_height/2}; ${pole_width/2}, ${pole_height}; ${-pole_width/2}, ${pole_height}"
      />
      ...
      <fixture
              ...
              group="1"
              shape="polygon"
              vertices="${-pole_width/2}, 0; ${pole_width/2}, 0; ${pole_width/2}, ${pole_height/2}; ${-pole_width/2}, ${pole_height/2}"
      />
    </body>
