...
import Box2D
import numpy as np
from gym.envs.box2d.parser.xml_types import XmlElem, XmlChild, XmlAttr, \
    XmlChildren

from gym.envs.box2d.parser.xml_attr_types import Tuple, Float, Choice, \
...
class XmlState(XmlElem):
    ...
    class Meta:
        ...
        transform = XmlAttr(
            "transform", Choice("id", "sin", "cos", "sin2", "cos2", "sin4", "cos4"))
